...
def main():
    ...
    # obstacles
    obstacles = []
    obs1 = DynamicObstacles(xo=-5.,yo=15.,phi=0.,alpha=2,beta=1.5,dx=.3, dy=.2, dphi=2.)
    obs2 = DynamicObstacles(xo=5.,yo=30.,phi=0.,alpha=2,beta=1.5,dx=-.15, dy=-.1, dphi=-2.)
    ...
    while True:
        # mpcc opt
        ctrl,pred_states,theta = mpcc_solver(robot_state=robot_state, contour=contour, obstacles=obstacles, param=param,
