...
def mpcc_solver(robot_state, contour, param, prev_optim_ctrl, prev_optim_theta, obstacles=None):
    """
    ...
    x,u,theta = linear_mpc_control(robot_state,obstacles,theta,contour,param,prev_optim_ctrl,prev_optim_theta)
